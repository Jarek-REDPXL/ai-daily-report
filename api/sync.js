...
const CARD_UPSERT = `
  INSERT INTO redpxl.cards
    (id, domains, title, summary, why, how, confidence, status, sources, tags, supersedes, related, created, updated, corroboration_count, action, thread_id, synced_at)
  VALUES
    ($1, $2::text[], $3, $4, $5, $6::text[], $7, $8, $9::jsonb, $10::text[], $11::text[], $12::text[], $13::date, $14::date, $15, $16, $17, now())
  ON CONFLICT (id) DO UPDATE SET
    ...
    created=EXCLUDED.created, updated=EXCLUDED.updated, corroboration_count=EXCLUDED.corroboration_count,
    action=EXCLUDED.action, thread_id=EXCLUDED.thread_id, synced_at=now()
`;
