...
## Mission
Step back from the daily stream and synthesize the week across all 7 domains: what actually mattered, the throughlines, and what the team should DO next week. Synthesis over recap — connect dots the dailies couldn't. Shared standards: digest/_house.md.
