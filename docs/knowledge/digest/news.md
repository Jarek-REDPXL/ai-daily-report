...
- **AI-trade repricing:** Broadcom's soft AI-chip guide (~$16B vs ~$17.2B expected, stock −12%, reported Jun 3) plus higher-for-longer rate worries rotated money OUT of AI names; by Jun 8 Asia, SoftBank −~6%, Samsung −~10%, SK Hynix −~8%, Kospi down ~8% (CNBC). **Still pressured Jun 10:** MU −4%+, AMD −3.5%, NVDA/INTC −2%+ premarket (hot jobs report → rate fears + US–Iran geopolitics); last week Nasdaq −~4% (TipRanks, Yahoo Finance). Huang reiterated multi-year demand. The "dip not regime change" call (due ~Jul 20) is still open and under pressure. (2026-06-10)
...
- **Frontier-model data governance becomes a procurement gate:** Anthropic's Claude Fable 5 (public Jun 9, ~80.3% SWE-Bench; GA in Copilot/Bedrock/Databricks) runs under a new **30-day data-retention** policy and **existing ZDR agreements don't apply** to Fable-5 traffic — Microsoft restricted it for employees over this. Capability vs data-provenance is now a live enterprise split. Card: card-ai-tooling-fable5-retention. Watch for an Anthropic enterprise carve-out or the restriction spreading. (2026-06-10)
