...
| Figma (release notes + Learn + Dev Mode MCP) | graphic | 64 | 5 | 2026-06-26 | Figma product releases + how-to (AI, capture, MCP design-to-code, Weave AI video, Config 2026 Motion + Shaders) | primary; behind Jun 13 capture-to-layers (graphic), Jun 16/17 Dev Mode MCP design↔code beat (web-design), Jun 21 Runway Aleph 2.0 in Weave beat, Jun 25 Figma Motion on-canvas-timeline beat (web-design) + Jun 26 Shader fills/effects prompt-to-WebGPU beat (graphic, Config 2026) |
...
| The Next Web | news | 50 | 2 | 2026-06-25 | tech/AI policy + product, design-tool launches | behind Jun 13 Fable-5/Mythos-5 shutdown coverage + Jun 25 Figma Config 2026 (web-design 3rd source); non-paywalled |
