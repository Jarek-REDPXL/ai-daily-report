...
| blog.google | ai-tooling | 62 | 4 | 2026-06-27 | Google/Gemini primary announcements | primary source; behind Gemini 3.5 Live Translate (Jun 9) + Jun 27 Gemini 3.5 Flash Computer Use beat (note: deepmind.google blog 302-redirects here — same source, not independent) |
...
| Bloomberg | ai-tooling | 62 | 7 | 2026-06-26 | markets, M&A, funding, infra financing, IPOs | paywalled; cross-check; behind Jun 11 Anthropic $35B TPU deal, Jun 13 Fable-5/Mythos-5 order, Jun 13 SpaceX IPO, Jun 16 Cursor deal / Nvidia $25B bond + Jun 26 OpenAI IPO-delay-to-2027 report (NYT-originated) → SoftBank tumble |
| CNBC | news | 66 | 12 | 2026-06-26 | markets/tech business, sell-offs, earnings, funding, IPOs | solid 2nd source; behind Jun 8 sell-off, Jun 11 chip-rebound, Jun 13 SpaceX IPO, Jun 16 greenshoe, Jun 18 Intel/Apple chip claim + Cramer note, Jun 20 Korea chip-bonus read, Jun 23 global tech rout, Jun 25 Micron blowout / Oracle ~21k cuts / OpenAI-Broadcom chip + Jun 26 SK Hynix record ~$29B Nasdaq ADR at ~$166 (often 403 to WebFetch — verify via 2nd source) |
...
| Reuters | ai-tooling | 59 | 5 | 2026-06-25 | wire confirmation, policy, M&A, AI-IP disputes | good 2nd source; behind EU–Meta WhatsApp order (Jun 9), Jun 16 SpaceX–Anysphere/Cursor $60B, Jun 19 Norway AI-in-schools near-ban + Jun 25 Anthropic↔Alibaba/Qwen distillation accusation |
...
| Social Media Today | paid | 60 | 6 | 2026-06-25 | ad-platform + social product changes | behind Jun 10 Meta Opportunity Score, Jun 13 Instagram "Your Algorithm", Jun 17 X Ads Manager GTM/CAPI, Jun 18 Pinterest scan, Jun 20 Meta Edits beat + Jun 25 Meta multimedia-ads best practices (paid) & Facebook Creator Studio relaunch (social); PROMOTE per ratings advisory; cross-check |
...
| TechCrunch | news | 59 | 6 | 2026-06-25 | tech-business, security, funding/M&A, agentic products, design/AI product launches | non-paywalled; behind Jun 9 MS OSS supply-chain, Jun 11 Coinbase-for-Agents, Jun 16 ChatGPT<50% / Cursor, Jun 18 Waymo / Baseten / Snap-Dotmo + Jun 18 Apple Brazil app stores + Jun 25 Figma Config (web-design), Facebook Creator Assistant (social), OpenAI/Broadcom Jalapeño + Cerebras (news) |
...
| Vercel (changelog + docs + blog) | web-dev | 59 | 4 | 2026-06-26 | framework/runtime product changes, Workflow/AI Gateway, Functions WebSockets, AI SDK | primary; behind Jun 13 Workflow-SDK-on-Nitro-v3 card, Jun 16 30-min Functions / inflight-cancellation beat, Jun 23 WebSocket-public-beta realtime beat + Jun 26 AI SDK 7 (Vercel Blog, scan-line) |
...
| Figma (release notes + Learn + Dev Mode MCP) | graphic | 66 | 6 | 2026-06-27 | Figma product releases + how-to (AI, capture, MCP design-to-code, Weave AI video, Config 2026 Motion + Shaders + agent Skills) | primary; behind Jun 13 capture-to-layers (graphic), Jun 16/17 Dev Mode MCP design↔code beat (web-design), Jun 21 Runway Aleph 2.0 in Weave beat, Jun 25 Figma Motion on-canvas-timeline beat (web-design), Jun 26 Shader fills/effects prompt-to-WebGPU beat (graphic) + Jun 27 design-agent custom Skills beat (web-design, Config 2026) |
...
| Engadget | news | 56 | 5 | 2026-06-27 | consumer-tech/AI product + platform changes, model-availability/policy | behind Jun 13 Instagram "Your Algorithm" + Jun 19 Norway AI-in-schools / Apple Brazil corroboration + Jun 23 OpenAI Daybreak + Jun 27 Anthropic Mythos-5 restoration (~100+ critical-infra orgs) & OpenAI GPT-5.6 three-variants preview; non-paywalled, reliable when CNBC/CNN 403 |
...
| Baymard Institute | cro | 61 | 4 | 2026-06-26 | checkout/cart-abandonment research, usability guidelines | authoritative primary research; backs the card-cro-* library (guest-checkout rated 5★) + Jun 15 CRO/AOV beat, Jun 21 threshold-margin beat + Jun 26 AI-diagnose-one-lever beat; PROMOTE per ratings advisory |
| Shopify (blog + help) | cro | 54 | 1 | 2026-06-26 | ecommerce AOV/CRO guides + benchmarks (AOV formula, modal order value, free-shipping threshold) | primary platform guidance; behind Jun 26 AI-diagnose-one-lever card (peg threshold to modal order value, not a round number) |
...
| Yahoo Finance | news | 56 | 4 | 2026-06-26 | markets/wire 2nd source (Reuters syndication), app-tracker writeups, index/ticker moves, sell-side notes, M&A | behind Jun 16 Cursor + ChatGPT-share, Jun 23 Kospi-crash primary, Jun 25 Oracle ~21k cuts / Qualcomm–Modular ~$3.9B / Morgan Stanley AI-selloff note + Jun 26 SoftBank tumble / Kioxia -12% (OpenAI IPO-delay selloff); non-paywalled, cross-check primary |
...
| Investing.com | news | 50 | 1 | 2026-06-25 | earnings-call transcripts + intraday ticker moves (markets) | useful for primary earnings-call quotes/guidance (Micron Q3) when CNBC/IR are paywalled/403; cross-check exact % (intraday/premarket directional) |
